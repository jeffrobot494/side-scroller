...
export const SCHEMA = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: "doomPerExpiry",
        label: "Doom / expired lead",
        type: "range",
        default: 0,
        min: 0,
        max: 40,
        step: 1,
        help: "Campaign health lost for every lead you let rot off the board, charged on the day it expires. Runs alongside the daily tick, so set 'Doom clock / day' to 0 to make the clock answer only to missions you ignored. The boss lead never expires and never charges. 0 disables.",
      },
      {
        key: "doomPerFailure",
