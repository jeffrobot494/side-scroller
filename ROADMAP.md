...
| Soldier progression P1–P4 — survivors earn their lead's stamped XP, level up on a doubling curve, and grow HP plus primary/secondary/other attributes, derived from lifetime XP over rules snapshotted per campaign; readouts on cards, Ops, Deploy and Results; a Progression editor tool. No rebase | `design/soldier-progression.md` · `tech/soldier-progression.md` |
